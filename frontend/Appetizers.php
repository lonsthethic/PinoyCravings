...
$getDish = "SELECT DISTINCT dish.dishID, title AS dishName, img, description,
            ...
            FROM dish 
            INNER JOIN ingredients ON dish.dishID = ingredients.dishID AND dish.category = 'Appetizers'
...
<head>
    ...
    <title>Appetizers - Pinoys Cravings</title>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                <i data-feather="package" class="mr-3 text-red-600"></i>
                Appetizers
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 drop-shadow-md">
            ...
            <?php else: ?>
                <div class="col-span-full bg-white rounded-lg shadow-md p-8 text-center">
                    ...
                    <p class="text-gray-600">There are no appetizer recipes in the database yet.</p>
                </div>
            <?php endif; ?>
        </div>
    </main>
